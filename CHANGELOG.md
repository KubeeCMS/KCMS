...
* Update to WordPress 5.0.2 ([#406](https://github.com/kubeecms/kcms/pull/406))
...
* Fix `DISABLE_WP_CRON` setting via ENV variable ([#229](https://github.com/kubeecms/kcms/pull/229))
